const { becomeAprovider, changeProviderStatus, getbookeduser, deleteBookeduser, findBookeduser, getAllBikes, getAllBikesp, getAllusers } = require("../controller/provider")
...
router.route("/bookeduser").get(findBookeduser)
